...
namespace WebJob
{
    class Program
    {
            ...
            )
        {
            ...
            string earthquakeurl = string.Format("http://earthquake.usgs.gov/fdsnws/event/1/query?starttime=2000-01-01 00:00:00&endtime={0}&latitude={1}&longitude={2}&minradiuskm=1000&maxradiuskm=1200&minmagnitude=6&format=csv&orderby=time",
